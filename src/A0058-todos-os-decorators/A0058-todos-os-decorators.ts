...
// Getter/Setter
function decoradorDeGeetterESetterNormal(
  prototipoDaClasse: any,
  nomePropriedade: string,
  descritorDePropriedade: PropertyDescriptor,
): any {
  // Chamado na criação do método
  // (ó pode ser aplicado no getter ou no setter - não em ambos)
...
function decoradorDeGeetterESetterEstatico(
  classConstructor: Constructor,
  nomePropriedade: string,
  descritorDePropriedade: PropertyDescriptor,
): any {
...
export class UmaPessoa {
  ...
  @decoradorDeGeetterESetterNormal
  ...
  @decoradorDeGeetterESetterEstatico
